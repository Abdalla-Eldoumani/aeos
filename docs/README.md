...
- **Framebuffer** (`framebuffer.c`): Graphics primitives (putpixel, fill_rect, draw_rect, draw_line, putchar, puts), which all accept signed coordinates and clip internally
